...
def main():
    ...
    parser.add_argument('--traffic-manager-port', default=2500, type=int,
                        help='Port to use for the TrafficManager (default: 2500)')
    ...
    # simulation setup, and scenarios is included in route files. 
    ...
    parser.add_argument("--debug-checkpoint", type=str, default='./simulation_results.json',
